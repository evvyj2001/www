...
<form  name="member_form" method="post" action="modify.php"> 
            ...
            <ul>
                <li class="form_row tel">
                  ...
                  <option value='019'>019</option>
                                ...
                                <li>
                                    <label class="hidden" for="hp2">전화번호중간4자리</label><input type="text" class="hp" name="hp2" id="hp2"  required value="<?= $hp2 ?>">
                                </li>
                                <li>
            ...
            <ul class="button">
                <li class="join_btn "><a href="#" onclick="check_input()">정보 수정</a></li>
                <li class="cancel_btn modify"><a href="../" onclick="">취소</a></li>
            </ul>
        </form> 
    </section> 
</article>   
