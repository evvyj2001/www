$(document).ready(function(){
    ...
    var h3=$('.content_area section:eq(3)').offset().top-300;
    var h4=$('.content_area section:eq(4)').offset().top-300;
    ...
    $(window).on('scroll',function(){
        ...
        //grid_5 스크롤 탭 활성화 범위 설정
        if(scroll>=0 && scroll<h1){
            $('.sub_menu_box.grid_5 ul li:eq(0)').find('a').addClass('spy');
        }else if(scroll>=h1 && scroll<h2){
            $('.sub_menu_box.grid_5 ul li:eq(1)').find('a').addClass('spy');
        }else if(scroll>=h2 && scroll<h3){
            $('.sub_menu_box.grid_5 ul li:eq(2)').find('a').addClass('spy');
        }else if(scroll>=h3 && scroll<h4){
            $('.sub_menu_box.grid_5 ul li:eq(3)').find('a').addClass('spy');
        }else if(scroll>=h4){
            $('.sub_menu_box.grid_5 ul li:eq(4)').find('a').addClass('spy');
        };        
    });
        //grid_5 스크롤 탭 클릭 시 이동 
        $('.sub_menu_box.grid_5 ul a').click(function(){
           var value=0;
            ...
            if($(this).hasClass('link1')){
                ...
                value=$('.content_area section:eq(3)').offset().top;
            }else if($(this).hasClass('link5')){
                value=$('.content_area section:eq(4)').offset().top;
            }
